...
<div class="team-feature-card border rounded-3 my-4">
  <figure class="team-photo-feature mb-4">
    <img class="team-photo-wide" src="/assets/img/estudio-arias-visconti-marchetti-equipo.webp" alt="Abogado Pablo Arias, equipo jurídico de sucesiones en Córdoba" loading="lazy" decoding="async" width="1400" height="933" />
  </figure>
  ...
  <div class="team-mini-grid">
    <figure class="attorney-photo-card mb-0">
      <img class="attorneys-trust-photo" src="/assets/img/pablo-jorge-arias-visconti.webp" alt="Pablo Arias, abogado de sucesiones en Córdoba" loading="lazy" decoding="async" width="1024" height="1024" />
      <figcaption>
        <strong>Pablo Arias</strong>
