...
<main id="main-content">
    ...
    <div class="site-shell home-hero-grid">
      <div class="home-hero-copy">
        ...
        <ul class="hero-trust-list" role="list" aria-label="Modalidad de atención">
          ...
          <li>Córdoba Capital e interior</li>
          <li>Atención presencial o remota según el caso</li>
        </ul>
        <p class="hero-disclaimer">No se prometen resultados. Cada caso requiere analizar la prueba, la etapa procesal y las decisiones judiciales.</p>
      </div>
      <aside class="urgent-panel" aria-labelledby="urgent-panel-title">
        <div class="urgent-panel-label">Orientación prioritaria</div>
        <h2 id="urgent-panel-title">Si necesitás actuar hoy</h2>
        <p>Elegí la situación más cercana a tu caso para ordenar los primeros pasos.</p>
        <nav class="urgent-links" aria-label="Situaciones penales urgentes">
          <a href="/familiar-detenido-cordoba/"><span>Tengo un familiar detenido</span><strong aria-hidden="true">01</strong></a>
          <a href="/citacion-a-declarar-cordoba/"><span>Recibí una citación</span><strong aria-hidden="true">02</strong></a>
          <a href="/prision-preventiva-cordoba/"><span>Hay riesgo para la libertad</span><strong aria-hidden="true">03</strong></a>
        </nav>
        <a class="urgent-panel-contact" href="/urgencias-penales-cordoba/">Ver urgencias penales</a>
      </aside>
    </div>
  </header>
  ...
  <section class="home-section situations-section" id="situaciones" aria-labelledby="situations-title">
    <div class="site-shell section-grid">
      ...
      <div class="situation-list">
        ...
        <a href="/citacion-a-declarar-cordoba/"><span class="situation-number">02</span><span><strong>Citación a declarar</strong><small>Cómo prepararse antes de presentarse o responder.</small></span></a>
        <a href="/imputado-cordoba/"><span class="situation-number">03</span><span><strong>Imputación penal</strong><small>Qué significa y qué conviene revisar desde el inicio.</small></span></a>
        <a href="/prision-preventiva-cordoba/"><span class="situation-number">04</span><span><strong>Prisión preventiva</strong><small>Análisis de riesgos, fundamentos y alternativas.</small></span></a>
        <a href="/excarcelacion-cordoba/"><span class="situation-number">05</span><span><strong>Pedido de excarcelación</strong><small>Revisión del expediente y de la situación de libertad.</small></span></a>
        <a href="/recursos-penales-cordoba/"><span class="situation-number">06</span><span><strong>Resolución desfavorable</strong><small>Plazos, fundamentos y vías de impugnación posibles.</small></span></a>
      </div>
    </div>
  </section>

  <section class="home-section services-section" aria-labelledby="services-title">
    <div class="site-shell services-layout">
  ...
  <section class="home-section method-section" aria-labelledby="method-title">
    <div class="site-shell">
      <header class="section-intro section-intro-wide">
        <div class="section-kicker">Método de trabajo</div>
        <h2 id="method-title">Claridad antes de decidir</h2>
        <p>Una causa penal no se resuelve con respuestas genéricas. El trabajo se organiza en etapas para comprender el problema y definir una línea defensiva fundada.</p>
      </header>
      <ol class="method-steps">
        <li><span>01</span><strong>Ordenar la situación</strong><p>Identificar la urgencia, la autoridad y la etapa procesal.</p></li>
        <li><span>02</span><strong>Revisar el expediente</strong><p>Analizar el hecho atribuido, la prueba y las resoluciones.</p></li>
        <li><span>03</span><strong>Evaluar riesgos</strong><p>Determinar plazos, medidas pendientes y puntos críticos.</p></li>
        <li><span>04</span><strong>Definir la estrategia</strong><p>Planificar actuaciones y alternativas según el caso concreto.</p></li>
      </ol>
    </div>
  </section>

  <section class="home-section professional-section" aria-labelledby="professional-title">
    <div class="site-shell professional-layout">
      <figure class="professional-photo-frame">
        <img src="/assets/img/pablo-jorge-arias-visconti-640.webp" srcset="/assets/img/pablo-jorge-arias-visconti-240.webp 240w, /assets/img/pablo-jorge-arias-visconti-640.webp 640w, /assets/img/pablo-jorge-arias-visconti.webp 1024w" sizes="(max-width: 767px) 88vw, 470px" alt="Abog. Pablo Jorge Arias Visconti, abogado penalista en Córdoba" loading="lazy" decoding="async" width="640" height="640" />
        <figcaption>Abog. Pablo Jorge Arias Visconti · M.P. 1-43613</figcaption>
      </figure>
  ...
  <section class="home-section locations-section" aria-labelledby="locations-title">
    <div class="site-shell">
      <header class="section-intro section-intro-wide">
  ...
  <section class="home-final-cta" aria-labelledby="home-final-title">
    <div class="site-shell final-cta-layout">
      <div>
