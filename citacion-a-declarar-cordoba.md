...
## Asesoramiento antes de una declaración penal
...
- carácter en el que debe presentarse, si está indicado;
- fecha, horario y lugar;
- número de expediente o referencia;
- motivo o acto para el que se convoca;
- instrucciones sobre documentación o comparecencia.

No te guíes únicamente por una fotografía recortada o por lo que otra persona interpretó. Los datos del documento y del expediente son los que permiten evaluar la situación.
...
Según el caso, el abogado puede:

1. revisar la citación y comprobar la autoridad interviniente;
